...
export default function SearchBar() {
  ...
  return (
    <div className="relative z-20 -mt-10 px-4 bg-[#0d3f2d] pt-0 pb-10">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl p-6 flex flex-col md:flex-row gap-6 items-end border border-white/60 shadow-[0_20px_60px_rgba(0,0,0,0.18)] animate-in fade-in slide-in-from-bottom-5 duration-700">
        ...
        <button
          ...
          className="bg-secondary text-primary font-black px-10 py-4 rounded-xl text-sm hover:bg-accent hover:shadow-lg active:scale-95 transition-all shadow-md whitespace-nowrap w-full md:w-auto"
        >
          ابحث الآن
        </button>
      </div>
