...
// // import { useGetContacts } from "@/hooks/admin/Usecontacts"; // ← عدّل المسار لو الاسم مختلف
...
//   // أحدث 5 رسائل — عدّل الـ hook لو الاسم مختلف عندك
...
//               Administrator
//             </p>
//             <p className="text-sm font-bold text-primary">A. Al-Mansour</p>
//           </div>
//           <div className="w-12 h-12 rounded-2xl bg-primary border-2 border-secondary flex items-center justify-center text-white font-bold shadow-luxury">
//             AM
//           </div>
//         </div> */}
//       </header>
...
//                       </p>
//                       {contact.status === "new" && (
//                         <span className="inline-block mt-1.5 px-2 py-0.5 bg-secondary/10 text-secondary text-[10px] rounded-full font-bold border border-secondary/20">
//                           جديد
//                         </span>
//                       )}
//                     </div>
